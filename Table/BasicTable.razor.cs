...
{
    public partial class BasicTable : ElementDialogBase //注意此处继承 ElementDialogBase 是因为这个组件用于演示弹窗的，因此需要继承 ElementDialogBase，通常情况下继承 ComponentBase 或 ElementComponentBase 即可
    {
